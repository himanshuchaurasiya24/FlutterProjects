...
import 'package:vyavasaay_mobile/models/diagnosis_type.dart';
import 'package:vyavasaay_mobile/models/doctor_model.dart';
import 'package:vyavasaay_mobile/models/patient_sex.dart';
import 'package:vyavasaay_mobile/widgets/custom_elevated_button.dart';
import 'package:vyavasaay_mobile/widgets/custom_text_form_field.dart';
            ...
            child: Column(
              children: [
                ...
                DiagnosisTypeSelector(
                    selectedDiagnosisType: selectedDiagnosisType, ref: ref),
                const SizedBox(
                  height: 10,
                ),
                CustomTextFormField(
