...
class _BillHistoryState extends State<BillHistory> {
  ...
  //                             onChanged: (p0) {
  //                               if (paidAmountContoller.text.isNotEmpty) {
  //                                 setState(() {
  ...
  //                             onChanged: (p0) {
  //                               setState(() {
  //                                 int total = totalAmountContoller.text.isEmpty
  //                                     ? 0
  //                                     : int.tryParse(
  //                                         totalAmountContoller.text)!;
  //                                 int paid = paidAmountContoller.text.isEmpty
  //                                     ? 0
  //                                     : int.tryParse(paidAmountContoller.text)!;
  //                                 int incentivePer = int.tryParse(
  //                                     incentivePerController.text)!;
  //                                 int discountByDoc =
  //                                     discountByDocController.text.isEmpty
  //                                         ? 0
  //                                         : int.tryParse(
  ...
  //                           debugPrint(totalAmountContoller.text);
  //                           debugPrint(paidAmountContoller.text);
  //                           debugPrint(discountByDocController.text);
  //                           debugPrint(discountByCenController.text);
  //                           debugPrint(incentiveContoller.text);
  //                           debugPrint(incentivePerController.text);
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                return ListTile(
                  ...
                  subtitle: Text(
                      snapshot.data![index].sex + snapshot.data![index].type),
                );
              },
            );
          },
