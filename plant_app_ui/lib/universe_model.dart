...
List<PlanetInfo> planets = [
  PlanetInfo(
    id: 1,
    name: 'Mercury',
    iconImage: 'assets/images/img/mercury.png',
    description:
  ...
  PlanetInfo(
    id: 2,
    name: 'Venus',
    iconImage: 'assets/images/img/venus.png',
    description:
  ...
  PlanetInfo(
      id: 3,
      name: 'Earth',
      iconImage: 'assets/images/img/earth.png',
      description:
  ...
  PlanetInfo(
    id: 4,
    name: 'Mars',
    iconImage: 'assets/images/img/mars.png',
    description:
  ...
  PlanetInfo(
    id: 5,
    name: 'Jupiter',
    iconImage: 'assets/images/img/jupiter.png',
    description:
  ...
  PlanetInfo(
    id: 6,
    name: 'Saturn',
    iconImage: 'assets/images/img/saturn.png',
    description:
  ...
  PlanetInfo(
    id: 7,
    name: 'Uranus',
    iconImage: 'assets/images/img/uranus.png',
    description:
  ...
  PlanetInfo(
    id: 8,
    name: 'Neptune',
    iconImage: 'assets/images/img/neptune.png',
    description:
