...
class DiagnosisInfo {
  ...
  factory DiagnosisInfo.fromMap(Map<String, dynamic> map) {
    return DiagnosisInfo(
      ...
      incentivePercent: map['incentivePercent'] as String,
  ...
  @override
  String toString() {
    return 'DiagnosisInfo(patientName: $patientName, patientAge: $patientAge, patientSex: $patientSex, date: $date, dignosisType: $dignosisType, diagnosisRemarks: $diagnosisRemarks, totalAmount: $totalAmount, paidAmount: $paidAmount, incentiveAmount: $incentiveAmount, doctorId: $doctorId, doctorName: $doctorName, incentivePercent: $incentivePercent, id: $id)';
  }
  ...
  bool operator ==(covariant DiagnosisInfo other) {
    ...
    return other.patientName == patientName &&
        ...
        other.incentivePercent == incentivePercent &&
        other.id == id;
  }
